...
extern int gff_gpl_init_vars();
extern int gff_gpl_cleanup_vars();
extern int gff_gpl_set_data_ptr(unsigned char *start, unsigned char *cpos);
extern int gff_gpl_push_data_ptr(unsigned char *data);

extern int gff_gpl_get_data_start_ptr(unsigned char **ret);
extern int gff_gpl_get_data_ptr(unsigned char **ret);
