...
int gff_char_delete(const int id) {
    printf("GFF CHAR DELETE IS NOT IMPLEMENTED!!!!\n");
    /*
...
/*
static void create_combat(gff_entity_t *pc, char *name, ds1_combat_t *combat) {
...
static void write_CHAR_entry(gff_chunk_header_t chunk, gff_entity_t *pc, ds1_combat_t *combat) {
...
int gff_char_add_character(gff_entity_t *pc, gff_psin_t *psi, gff_spell_list_t *spells, gff_psionic_list_t *psionics, char *name) {
    ds1_combat_t combat;
    ...
    if (open_slot == -1) {
        ...
        gff_add_chunk(CHARSAVE_GFF_INDEX, GFF_PSST, id, (char*)res_ids, sizeof(gff_psionic_list_t));
        gff_add_chunk(CHARSAVE_GFF_INDEX, GFF_SPST, id, (char*)res_ids, sizeof(gff_spell_list_t));
        gff_add_chunk(CHARSAVE_GFF_INDEX, GFF_PSIN, id, (char*)res_ids, sizeof(gff_psin_t));
